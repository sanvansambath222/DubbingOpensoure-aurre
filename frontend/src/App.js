...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden" style={{ fontFamily: "'IBM Plex Sans', sans-serif" }}>
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-white/70 border-b border-black/10 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-semibold text-zinc-950 tracking-tight" style={{ fontFamily: "'Outfit', sans-serif" }}>KhmerDub</span>
          </div>
          <button data-testid="google-login-button" onClick={handleLogin}
            className="px-5 py-2 bg-zinc-950 text-zinc-950 text-sm font-semibold rounded-sm hover:bg-zinc-800 transition-colors">
            Sign In
          </button>
        </div>
      </header>
